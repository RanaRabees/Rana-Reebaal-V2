...
export default function Expertise() {
  const [texts] = useState({
    ...
    item1Title: `Web3.0 Development`,
    item2Title: `Blockchain Development`,
    item3Title: `Web Development`,
    item1: `There is no one who loves pain itself, who seeks after it and wants to have it, simply because it is pain...`,
    item2: `There is no one who loves pain itself, who seeks after it and wants to have it, simply because it is pain...`,
    item3: `There is no one who loves pain itself, who seeks after it and wants to have it, simply because it is pain...`,
  });
