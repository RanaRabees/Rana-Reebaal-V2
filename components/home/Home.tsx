...
export default function Home() {
  const [texts] = useState({
    title: "Rana Reebaal",
    subtitle:
      "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...<br/><br/> There is no one who loves pain itself, who seeks after it and wants to have it, simply because it is pain...",
  });
  return (
    <>
      <div className={`intro`}>
